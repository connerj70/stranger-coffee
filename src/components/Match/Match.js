...
class Match extends Component {
    ...
    handleNewMatch() {
        if (!this.props.city) {
            alert(
                "Please edit your profile and fill in which city you are from"
            );
        } else {
    ...
    handleAccept() {
        axios
            .put(`/api/match/${this.props.currentMatch.match_id}`)
            .then(resp => {
            ...
            <div className="match">
                {!this.props.currentMatch.location ? (
                    ...
                    <div className="match_matched">
                        {this.props.currentMatch.user2_id ===
                        this.props.user.id ? (
                        ...
                        <div className="match_matched-sub-container">
                            ...
                            {this.props.currentMatch.date ? (
                                <span id="match_matched-date">
                                    {
                                        this.props.currentMatch.date.split(
                                            "T0"
                                        )[0]
                                    }{" "}
                                    7PM
