      ...
      <div className="edit-profile">
        {this.props.user.name ? (
          <div>
            ...
            <h1 className="edit-profile_heading">
            ...
            <div className="edit-profile_button-container">
              <button className="edit-profile_button" onClick={this.handleSave}>
                SAVE
              </button>
              <Link to="/profile">
                <button className="edit-profile_button edit-profile_cancel-button">
                  CANCEL
                </button>
              </Link>
            </div>
          ...
          <div>
            <h1>unauthorized</h1>
            <a style={{ color: "orange", marginTop: "30px" }} href="/auth/me">
              Log In/Signup
            </a>
          </div>
        )}
